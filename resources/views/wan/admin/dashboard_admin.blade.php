    ...
    <!-- <ul class="main-search-list-defaultlist d-none">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100" href="app-user-view-account.html">
                <div class="d-flex align-items-center">
                    ...
                    <div class="search-data">
                        <p class="search-data-title mb-0">Rizvan</p><small class="text-muted">UI designer</small>
                    </div>
                </div>
            </a></li>
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100" href="app-user-view-account.html">
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item me-auto"><a class="navbar-brand" href="/dashboard_admin_wan">
                            ...
                            <div class="card">
                                <div class="card-header flex-column align-items-start pb-0">
                                    <div class="avatar bg-light-primary p-50 m-0">
                                        <div class="avatar-content">
                                            <i data-feather="radio" class="font-medium-5"></i>
                                        </div>
                                    </div>
                                    <h2 class="fw-bolder mt-1">398</h2>
                                    <p class="card-text">BTS TELKOMSEL</p>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-header flex-column align-items-start pb-0">
                                    <div class="avatar bg-light-warning p-50 m-0">
                                        <div class="avatar-content">
                                            <i data-feather="cast" class="font-medium-5"></i>
                                        </div>
                                    </div>
                                    <h2 class="fw-bolder mt-1">294</h2>
                                    <p class="card-text">Customer OLO</p>
                                </div>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-nowrap">{{ $data_all_teknisi->nik }}</td>
                                                    <td class="text-nowrap">{{ $data_all_teknisi->teknisi_name }}</td>
                            ...
                            <div class="card-body">
                                <div class="employee-task d-flex justify-content-between align-items-center">
                                    <div class="d-flex flex-row">
                                        ...
                                        <div class="my-auto">
                                            <h6 class="mb-0">M Nur Cholis S</h6>
                                            <small>Teknisi TSEL</small>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <small class="text-muted me-75">37 Point</small>
                                ...
                                <div class="employee-task d-flex justify-content-between align-items-center">
                                    <div class="d-flex flex-row">
                                        ...
                                        <div class="my-auto">
                                            <h6 class="mb-0">Bagus Andyanto</h6>
                                            <small>Teknisi TSEL</small>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <small class="text-muted me-75">30 Point</small>
                                ...
                                <div class="employee-task d-flex justify-content-between align-items-center">
                                    <div class="d-flex flex-row">
                                        ...
                                        <div class="my-auto">
                                            <h6 class="mb-0">Rendra Prahasta</h6>
                                            <small>Teknisi TSEL</small>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <small class="text-muted me-75">28 Point</small>
                                ...
                                <div class="employee-task d-flex justify-content-between align-items-center">
                                    <div class="d-flex flex-row">
                                        ...
                                        <div class="my-auto">
                                            <h6 class="mb-0">Erwanto</h6>
                                            <small>Teknisi OLO</small>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <small class="text-muted me-75">24 Point</small>
                                ...
                                <div class="employee-task d-flex justify-content-between align-items-center">
                                    <div class="d-flex flex-row">
                                        ...
                                        <div class="my-auto">
                                            <h6 class="mb-0">Kery Anas Riskianto</h6>
                                            <small>Teknisi TSEL</small>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <small class="text-muted me-75">20 Point</small>
                                ...
                                <div class="employee-task d-flex justify-content-between align-items-center">
                                    <div class="d-flex flex-row">
                                        ...
                                        <div class="my-auto">
                                            <h6 class="mb-0">Tri Sutrisno</h6>
                                            <small>Teknisi TSEL</small>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center">
                                        <small class="text-muted me-75">15 Point</small>
