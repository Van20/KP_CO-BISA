                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/detail_teknisi_wan">Technician</a>
                                    </li>
                            ...
                            <div class="card">
                                <div class="col">
                                    <div class="card-header border-bottom">
                                        <h4 class="card-title col-8">Jadwal Teknisi WAN</h4>

                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            <!--Import Modal -->
                                            <form class="form-inline" role="form" action="/jadwal_wan/import" method="post" enctype="multipart/form-data">
                                                {{csrf_field()}}
                                            ...
                                            <!-- Export Order -->   
                                            <form class="form-inline" role="form" action="/jadwal_wan/export" method="get" enctype="multipart/form-data">
                                            {{csrf_field()}} 
                                                <div class="image-upload">
                                ...
                                <div class="table-responsive" style="margin:10px; width:auto; height:auto;">
                                    <font size="2">    
                                    <table id="table_datin" class="table table-sm table-bordered">
                                        ...
                                        @foreach($all_teknisi as $data_all_teknisi)
                                            <tr>
                                                ...
                                                <td style="max-width:150px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; text-align:center">{{ $data_all_teknisi->cholis }}</td>
                                                <td style="max-width:80px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; text-align:center">{{ $data_all_teknisi->bagus }}</td>
                                                <td style="max-width:100px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; text-align:center">{{ $data_all_teknisi->rendra }}</td>
                                                <td style="max-width:150px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; text-align:center">{{ $data_all_teknisi->tri }}</td>
                                                <td style="max-width:80px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; text-align:center">{{ $data_all_teknisi->joelian }}</td>
                                                <td style="max-width:100px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; text-align:center">{{ $data_all_teknisi->erwanto }}</td>
                                                <td style="max-width:150px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; text-align:center">{{ $data_all_teknisi->anas }}</td>
                                                <td style="max-width:80px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; text-align:center">{{ $data_all_teknisi->warsito }}</td>
                                                <td style="max-width:100px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; text-align:center">{{ $data_all_teknisi->handy }}</td>
                                                <td style="max-width:150px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; text-align:center">{{ $data_all_teknisi->amin }}</td>
                                                ...
                                                <div class="modal fade" id="deleteModal<?php echo $data_all_teknisi->id; ?>" tabindex="-1" role="dialog" aria-labelledby="Delete" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="/delete/teknisi_wan/{{ $data_all_teknisi->id }}" method="get" role="form">
                                                                    {{ csrf_field() }}
                                                ...
                                                <div class="modal fade" id="viewModal<?php echo $data_all_teknisi->id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                    <div class="modal-dialog modal-lg" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="/update_teknisi_wan" method="get" role="form">
                                                                {{ csrf_field() }}
                                                                    <div class="card">
                                                                        <div class="card-body">
                                                                            ...
                                                                            <div class="info-container">
                                                                                <ul class="list-unstyled">
                                                                                    ...
                                                                                    <!-- <li class="mb-75">
                                                                                        <span class="fw-bolder me-25">Username MySolution : </span>
                                                                                        <span>{{ $data_all_teknisi->username_mysol }}</span>
                                                                                    </li>
                                                                                    <li class="mb-75">
                                                                                        <span class="fw-bolder me-25">Password MySolution : </span>
                                                                                        <span>{{ $data_all_teknisi->password_mysol }}</span>
                                                                                    </li> -->
                                                                                </ul>
                                                                            </div>
                                                                        </div>
                                                    ...
                                                    <div class="modal-dialog modal-lg" role="document">
                                                        ...
                                                        <div class="modal-body pb-5 px-sm-5 pt-50">
                                                            ...
                                                            <div class="text-left mt-2">
                                                                ...
                                                                <form id="edit_form<?php echo $data_all_teknisi->id; ?>" class="form" action="/update_jadwal_teknisi_wan" method="post">
                                                                ...
                                                                <select class="form-select" hidden value="{{ $data_all_teknisi->tanggal }}" id="tanggal" name="tanggal">    
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6 col-12">
                                                                            <div class="mb-1">
                                                                                <label class="form-label" for="cholis">Cholis</label>
                                                                                    <select class="form-select" id="cholis" name="cholis" required>     
                                                                                        <optgroup label="Pilih Presensi">                                               
                                                                                        <option value="M"{{$data_all_teknisi->cholis == "M" ? 'selected' : ''}}>M</option>                                                  
                                                                                        <option value="L"{{$data_all_teknisi->cholis == "L" ? 'selected' : ''}}>L</option>                                                
                                                                                        <option value="C"{{$data_all_teknisi->cholis == "C" ? 'selected' : ''}}>C</option>
                                                                                    </select>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6 col-12">
                                                                            <div class="mb-1">
                                                                                <label class="form-label" for="bagus">Bagus</label>
                                                                                    <select class="form-select" id="bagus" name="bagus" required>     
                                                                                        <optgroup label="Pilih Presensi">                                              
                                                                                        <option value="M"{{$data_all_teknisi->bagus == "M" ? 'selected' : ''}}>M</option>                                                  
                                                                                        <option value="L"{{$data_all_teknisi->bagus == "L" ? 'selected' : ''}}>L</option>                                              
                                                                                        <option value="C"{{$data_all_teknisi->bagus == "C" ? 'selected' : ''}}C</option>
                                                                                    </select>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6 col-12">
                                                                            <div class="mb-1">
                                                                                <label class="form-label" for="rendra">Rendra</label>
                                                                                    <select class="form-select" id="rendra" name="rendra" required>     
                                                                                        <optgroup label="Pilih Presensi">                                              
                                                                                        <option value="M"{{$data_all_teknisi->rendra == "M" ? 'selected' : ''}}>M</option>                                                  
                                                                                        <option value="L"{{$data_all_teknisi->rendra == "L" ? 'selected' : ''}}>L</option>                                                  
                                                                                        <option value="C"{{$data_all_teknisi->rendra == "C" ? 'selected' : ''}}>C</option>
                                                                                    </select>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6 col-12">
                                                                            <div class="mb-1">
                                                                                <label class="form-label" for="tri">Tri</label>
                                                                                    <select class="form-select" id="tri" name="tri" required>     
                                                                                        <optgroup label="Pilih Presensi">                                              
                                                                                        <option value="M"{{$data_all_teknisi->tri == "M" ? 'selected' : ''}}>M</option>                                                  
                                                                                        <option value="L"{{$data_all_teknisi->tri == "L" ? 'selected' : ''}}>L</option>                                                 
                                                                                        <option value="C"{{$data_all_teknisi->tri == "C" ? 'selected' : ''}}>C</option>
                                                                                    </select>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6 col-12">
                                                                            <div class="mb-1">
                                                                                <label class="form-label" for="joelian">Joelian</label>
                                                                                    <select class="form-select" id="joelian" name="joelian" required>     
                                                                                        <optgroup label="Pilih Presensi">                                              
                                                                                        <option value="M"{{$data_all_teknisi->joelian == "M" ? 'selected' : ''}}>M</option>                                                  
                                                                                        <option value="L"{{$data_all_teknisi->joelian == "L" ? 'selected' : ''}}>L</option>                                                
                                                                                        <option value="C"{{$data_all_teknisi->joelian == "C" ? 'selected' : ''}}>C</option>
                                                                                    </select>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6 col-12">
                                                                            <div class="mb-1">
                                                                                <label class="form-label" for="erwanto">Erwanto</label>
                                                                                    <select class="form-select" id="erwanto" name="erwanto" required>     
                                                                                        <optgroup label="Pilih Presensi">                                              
                                                                                        <option value="M"{{$data_all_teknisi->erwanto == "M" ? 'selected' : ''}}>M</option>                                                  
                                                                                        <option value="L"{{$data_all_teknisi->erwanto == "L" ? 'selected' : ''}}>L</option>                                               
                                                                                        <option value="C"{{$data_all_teknisi->erwanto == "C" ? 'selected' : ''}}>C</option>
                                                                                    </select>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6 col-12">
                                                                            <div class="mb-1">
                                                                                <label class="form-label" for="aris">Anas</label>
                                                                                    <select class="form-select" id="anas" name="anas" required>     
                                                                                        <optgroup label="Pilih Presensi">                                              
                                                                                        <option value="M"{{$data_all_teknisi->anas == "M" ? 'selected' : ''}}>M</option>                                                  
                                                                                        <option value="L"{{$data_all_teknisi->anas == "L" ? 'selected' : ''}}>L</option>                                                
                                                                                        <option value="C"{{$data_all_teknisi->anas == "C" ? 'selected' : ''}}>C</option>
                                                                                    </select>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6 col-12">
                                                                            <div class="mb-1">
                                                                                <label class="form-label" for="irswarsitoan">Warsito</label>
                                                                                    <select class="form-select" id="warsito" name="warsito" required>     
                                                                                        <optgroup label="Pilih Presensi">                                              
                                                                                        <option value="M"{{$data_all_teknisi->warsito == "M" ? 'selected' : ''}}>M</option>                                                  
                                                                                        <option value="L"{{$data_all_teknisi->warsito == "L" ? 'selected' : ''}}>L</option>                                             
                                                                                        <option value="C"{{$data_all_teknisi->warsito == "C" ? 'selected' : ''}}>C</option>
                                                                                    </select>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6 col-12">
                                                                            <div class="mb-1">
                                                                                <label class="form-label" for="handy">Handy</label>
                                                                                    <select class="form-select" id="handy" name="handy" required>     
                                                                                        <optgroup label="Pilih Presensi">                                              
                                                                                        <option value="M"{{$data_all_teknisi->handy == "M" ? 'selected' : ''}}>M</option>                                                  
                                                                                        <option value="L"{{$data_all_teknisi->handy == "L" ? 'selected' : ''}}>L</option>                                                
                                                                                        <option value="C"{{$data_all_teknisi->handy == "C" ? 'selected' : ''}}>L</option>
                                                                                    </select>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6 col-12">
                                                                            <div class="mb-1">
                                                                                <label class="form-label" for="amin">Amin</label>
                                                                                    <select class="form-select" id="amin" name="amin" required>     
                                                                                        <optgroup label="Pilih Presensi">                                              
                                                                                        <option value="M"{{$data_all_teknisi->amin == "M" ? 'selected' : ''}}>M</option>                                                  
                                                                                        <option value="L"{{$data_all_teknisi->amin == "L" ? 'selected' : ''}}>L</option>                                                
                                                                                        <option value=C"{{$data_all_teknisi->amin == "C" ? 'selected' : ''}}>L</option>
                                                                                    </select>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-12">
