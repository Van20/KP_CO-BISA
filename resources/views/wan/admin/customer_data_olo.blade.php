    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="/customer_data_olo"><i data-feather="book-open"></i><span class="menu-item text-truncate" data-i18n="Kanban">Data Customer</span></a>
                <ul class="menu-content">
                    ...
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/customer_data_olo">Data Customer</a>
                                    </li>
                                    <li class="breadcrumb-item active">OLO
                                    </li>
                                </ol>
                            </div>
                        </div>
                                ...
                                <!-- Responsive tables start -->
                                    <div class="card-datatable" style="margin:10px; width:auto; height:auto;">
                                        <table id="table_datin" class="table table-striped m-0">
                                            ...
                                            <tbody>
                                                @foreach($list_data_olo as $data_all_customer)
                                                    <tr style="text-align:center">
                                                        <td style="max-width:10px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis">{{ $loop->iteration }}</td>
                                                        <td style="max-width:80px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis">{{ $data_all_customer->customer_name }}</td>
                                                        <td style="max-width:115px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis">{{ $data_all_customer->summary }}</td>
                                                        ...
                                                        @endif
                                                        <td style="max-width:30px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis">{{ $data_all_customer->segment }}</td>
                                                                                            ...
                                                                                            <div role="tabpanel" class="tab-pane fade show active" id="order<?php echo $data_all_customer->id; ?>">
                                                                                                ...
                                                                                                <div class="info-container">
                                                                                                    <ul class="list-unstyled">
                                                                                                        <li class="mb-75">
                                                                                                            <span class="fw-bolder me-25">Customer Identity : </span>
                                                                                                            <span>{{ $data_all_customer->customer_name }}</span>
                                                                                                        </li>
                                                                                                        <li class="mb-75">
                                                                                                            <span class="fw-bolder me-25">Summary : </span>
                                                                                                            <span>{{ $data_all_customer->summary }}</span>
                                                                                                        </li>
                                                                                                        <li class="mb-75">
                                                                                                            <span class="fw-bolder me-25">FO Link : </span>
                                                                                                            @if($data_all_customer->link === 'gpon' OR $data_all_customer->link === 'GPON' OR $data_all_customer->link === 'Gpon' )
                                                                                                                <span class="badge badge-light-primary">{{ $data_all_customer->link }}</span>
                                                                                                            @elseif($data_all_customer->link === 'direct metro' OR $data_all_customer->link === 'DIRECT METRO' OR $data_all_customer->link === 'Direct Metro' )
                                                                                                                <span class="badge badge-light-success">{{ $data_all_customer->link }}</span>
                                                                                                            @else
                                                                                                                <span class="badge badge-pill badge-danger">{{ $data_all_customer->link }}</span>
                                                                                                            @endif
                                                                                                        </li>
                                                                                                        <li class="mb-75">
                                                ...
                                                <div class="modal fade" id="editModal<?php echo $data_all_customer->id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                    <div class="modal-dialog modal-lg" role="document">
                                                        ...
                                                        <div class="modal-header bg-outline-primary">
                                                            <h4 class="modal-title"><b>Detail Customer {{ $data_all_customer->site_id }} {{ $data_all_customer->site_name }}</b></h4>
                                                            <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close"></button>
                                                        </div>
                                                                    ...
                                                                    <div class="tab-content">
                                                                        <div role="tabpanel" class="tab-pane fade show active" id="tab1<?php echo $data_all_customer->id; ?>">
                                                                            <div class="form-group mt-2">
                                                                                <b><label for="exampleInputEmail1">Customer Identity</label></b>
                                                                            ...
                                                                            <div class="form-group mt-2">
                                                                                ...
                                                                                <input class="form-control bg-white" type="text" value="{{ $data_all_customer->summary}}" aria-label="readonly input example" name="summary">
                                                                            </div>
