            ...
            <div class="content-body">
                ...
                <section class="vertical-wizard">
                    <div class="bs-stepper vertical vertical-wizard-example">
                        ...
                        @foreach($cnop_wan as $order_cnop_edit)
                        <form class="bs-stepper-content" action="/update_order_wan" method="post">
                        {{ csrf_field() }}
                        <input type="hidden" name="id" value="{{ $order_cnop_edit->id }}"> 
                                ...
                                <div id="account-details-vertical" class="content" role="tabpanel" aria-labelledby="account-details-vertical-trigger">
                                    ...
                                    <div class="row">
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" id="no_order" class="form-control" placeholder="1-21493520980" value="{{ $order_cnop_edit->no_order }}" required name="no_order"/>
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            <div class="mb-1 position-relative">
                                                <label class="form-label" for="tgl_order">Tgl Order</label>
                                                <input type="text" class="form-control pickadate-short-string" name="tgl_order" id="tgl_order" placeholder="2020-11-27" value="{{ $order_cnop_edit->tgl_order }}"required/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" id="order_type" class="form-control" placeholder="ASTINET" value="{{ $order_cnop_edit->order_type }}" required name="order_type"/>
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            <div class="mb-0">
                                                    <label class="form-label" for="segment">Segment</label>
                                                    <select class="hide-search form-select" id="segment" name="segment" value="{{ $order_cnop_edit->segment }}" name="segment" >
                                    ...
                                    <div class="row">
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="number" id="bandwidth" class="form-control" placeholder="2, 5, 10.." value="{{ $order_cnop_edit->bandwidth }}" required name="bandwidth"/>
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            <div class="mb-0">
                                                <label class="form-label" for="sto_name">STO</label>
                                                <select class="select2 w-100" id="sto_name" name="sto_name" required>                                                  
                                                    <option value="MYR"{{$order_cnop_edit->sto_name == "MYR" ? 'selected' : ''}}>Manyar (MYR)</option>                                                  
                                                    <option value="TPO"{{$order_cnop_edit->sto_name == "TPO" ? 'selected' : ''}}>Tropodo (TPO)</option>                                                  
                                                    <option value="RKT"{{$order_cnop_edit->sto_name == "RKT" ? 'selected' : ''}}>Rungkut (RKT)</option>                                                  
                                                    <option value="WRU"{{$order_cnop_edit->sto_name == "WRU" ? 'selected' : ''}}>Waru (WRU)</option>                                                  
                                                    <option value="JGR"{{$order_cnop_edit->sto_name == "JGR" ? 'selected' : ''}}>Jagir (JGR)</option>                                                  
                                                    <option value="DMO"{{$order_cnop_edit->sto_name == "DMO" ? 'selected' : ''}}>Darmo (DMO))</option>                                                  
                                                    <option value="IJK"{{$order_cnop_edit->sto_name == "IJK" ? 'selected' : ''}}>Injoko (IJK)</option>                                                  
                                                    <option value="GBG)"{{$order_cnop_edit->sto_name == "GBG" ? 'selected' : ''}}>Gubeng (GBG)</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="mb-1 col-md-6">
                                            <div class="mb-1    ">
                                                    ...
                                                    <select class="hide-search form-select" id="status_order" name="status_order" value="{{ $order_cnop_edit->status_order }}" required name="status_order">
                                        ...
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <textarea class="form-control" id="deskripsi_order" rows="2" placeholder="Tambahkan Deskripsi pada Order (Optional)" required name="deskripsi_order">{{ $order_cnop_edit->deskripsi_order }}</textarea>
                                        </div>
                                    </div>
                                ...
                                <div id="personal-info-vertical" class="content" role="tabpanel" aria-labelledby="personal-info-vertical-trigger">
                                    ...
                                    <div class="row">
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" id="customer_name" class="form-control" placeholder="Rizvan Ariyanto" value="{{ $order_cnop_edit->customer_name }}" required name="customer_name"/>
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            <label class="form-label" for="alamat">Alamat</label>
                                            <input type="text" id="alamat" class="form-control" placeholder="Jl. Ketintang Barat, Surabaya" value="{{ $order_cnop_edit->alamat }}" required name="alamat"/>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="mb-1 col-md-6">
                                            <label class="form-label" for="customer_tagging">Tagging Pelanggan</label>
                                            <input type="text" id="customer_tagging" class="form-control" placeholder="-7.3382, 112.7648" value="{{ $order_cnop_edit->customer_tagging }}" required name="customer_tagging"/>
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            <label class="form-label" for="pic">No.Telp</label>
                                            <input type="number" id="pic" class="form-control" placeholder="08xx-xxxx-xxxx" value="{{ $order_cnop_edit->pic }}" required name="pic"/>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="mb-1 col-md-6">
                                            <label class="form-label" for="qr_code">QR Code</label>
                                            <input type="text" id="qr_code" class="form-control" placeholder="JD02238410SX2" value="{{ $order_cnop_edit->qr_code }}" required name="qr_code"/>
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-between">
                                ...
                                <div id="address-step-vertical" class="content" role="tabpanel" aria-labelledby="address-step-vertical-trigger">
                                    ...
                                    <div class="row">
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" id="olt_name" class="form-control" placeholder="GPON00-D5-WRU-3" value="{{ $order_cnop_edit->olt_name }}" required name="olt_name"/>
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            <label class="form-label" for="olt_port">OLT Port</label>
                                            <input type="text" id="olt_port" class="form-control" placeholder="0/1/4 ont 100" value="{{ $order_cnop_edit->olt_port }}" required name="olt_port"/>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="mb-1 col-md-6">
                                            <label class="form-label" for="olt_ip">OLT IP</label>
                                            <input type="text" id="olt_ip" class="form-control" placeholder="172.16.10.22" value="{{ $order_cnop_edit->olt_ip }}" required name="olt_ip"/>
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            <label class="form-label" for="metro_name">METRO Name</label>
                                            <input type="text" id="metro_name" class="form-control" placeholder="ME-D5-WR" value="{{ $order_cnop_edit->metro_name }}" required name="metro_name"/>
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            <label class="form-label" for="metro_ip">METRO IP</label>
                                            <input type="text" id="metro_ip" class="form-control" placeholder="172.16.22.110" value="{{ $order_cnop_edit->metro_ip }}" required name="metro_ip"/>
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            <label class="form-label" for="metro_port">METRO Port</label>
                                            <input type="text" id="metro_port" class="form-control" placeholder="Eth-Trunk53" value="{{ $order_cnop_edit->metro_port }}" required name="metro_port"/>
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            <label class="form-label" for="sn">SN ONT</label>
                                            <input type="text" id="sn" class="form-control" placeholder="ZTEGCC577F65" value="{{ $order_cnop_edit->sn }}" required name="sn"/>
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            <label class="form-label" for="vlan">VLAN</label>
                                            <input type="text" id="vlan" class="form-control" placeholder="2782" value="{{ $order_cnop_edit->vlan }}" required name="vlan"/>
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-between">
                                        <a class="btn btn-primary btn-prev">
                                ...
                                <div id="social-links-vertical" class="content" role="tabpanel" aria-labelledby="social-links-vertical-trigger">
                                    ...
                                    <div class="row">
                                        <div class="mb-1 col-md-6">
                                            ...
                                            <input type="text" id="odc_name" class="form-control" placeholder="ODC-WR1-FBJ" value="{{ $order_cnop_edit->odc_name }}" required name="odc_name"/>
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            <label class="form-label" for="odp_name">ODP Name</label>
                                            <input type="text" id="odp_name" class="form-control" placeholder="ODP-WR1-FBJ/04" value="{{ $order_cnop_edit->odp_name }}" required name="odp_name"/>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="mb-1 col-md-6">
                                            <label class="form-label" for="odp_tagging">ODP Tagging</label>
                                            <input type="text" id="odp_tagging" class="form-control" placeholder="-7.2443, 112.34345" value="{{ $order_cnop_edit->odp_tagging }}" required name="odp_tagging"/>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="mb-1 col-md-6">
                                            <label class="form-label" for="redaman">Redaman</label>
                                            <input type="text" id="redaman" class="form-control" placeholder="-17 dBm" value="{{ $order_cnop_edit->redaman }}" required name="redaman"/>
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-between">
                                        <a class="btn btn-primary btn-prev">
