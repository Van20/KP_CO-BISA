            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Add Technician Data</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/detail_teknisi_wan">Technician Data</a>
                                    </li>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Input Data Manual</h4>
                                </div>
                                <div class="card-body">
                                    <form class="form" method="post" action="/store_teknisi_manual_wan">
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}" />
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1" >
                                                    <label class="form-label" for="nik">NIK</label>
                                                    <input type="number" id="nik" class="form-control bg-white" placeholder="99180252" name="nik" required/>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1 position-relative">
                                                    <label class="form-label" for="teknisi_name">Nama Teknisi</label>
                                                    <input type="text" class="form-control bg-white" name="teknisi_name" id="teknisi_name" placeholder="R..." aria-label="readonly input example" name="teknisi_name" required/>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1 position-relative">
                                                    <label class="form-label" for="no_hp">No. Telp</label>
                                                    <input type="number" class="form-control bg-white" name="no_hp" id="no_hp" placeholder="08xx-xxxx-xxxx" aria-label="readonly input example" name="no_hp" required/>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1 position-relative">
                                                    <label class="form-label" for="tgl_lahir">Tgl Lahir</label>
                                                    <input type="text" class="form-control flatpickr-basic" name="tgl_lahir" id="tgl_lahir" placeholder="1990-11-27""/>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1 position-relative">
                                                    <label class="form-label" for="email">Email</label>
                                                    <input type="text" class="form-control bg-white" name="email" id="email" placeholder="rizvan@gmail.com" aria-label="readonly input example" name="email" required/>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1 position-relative">
                                                    <label class="form-label" for="no_ktp">No. KTP</label>
                                                    <input type="number" class="form-control bg-white" name="no_ktp" id="no_ktp" placeholder="350xxxxxxxxxxxxx" aria-label="readonly input example" name="no_ktp" required/>
                                                </div>
                                            </div>
                                            <div class="col-12">
