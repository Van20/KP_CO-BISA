            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Technician Data</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="/detail_teknisi_wan">Technician</a>
                                    </li>
                                    <li class="breadcrumb-item active">Technician Data
                                    </li>
                                </ol>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="col">
                                    <div class="card-header border-bottom">
                                        <h4 class="card-title col-8">CCAN Technician Data</h4>

                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            <!-- Add Manual Data -->   
                                            <a href="/add_data_teknisi_wan">
                                                <button type="button" class="btn btn-relief-primary btn-gradient-primary ms-1" data-bs-toggle="tooltip" title="Add Data Teknisi">
                                ...
                                <div class="card-datatable" style="margin:10px; width:auto; height:auto;">
                                    <table id="table_datin" class="table table-striped m-0">
                                        ...
                                        @foreach($all_teknisi as $data_all_teknisi)
                                            <tr>
                                                <td style="max-width:60px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; text-align:center">{{ $data_all_teknisi->nik }}</td>
                                                <td style="max-width:150px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; text-align:center">{{ $data_all_teknisi->teknisi_name }}</td>
                                                <td style="max-width:80px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; text-align:center">{{ $data_all_teknisi->tgl_lahir }}</td>
                                                <td style="max-width:100px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; text-align:center">{{ $data_all_teknisi->no_hp }}</td>
                                                <td style="text-align:center">
                                                    <div class="col-12">
                                                        <a href="#" data-toggle="modal" data-bs-toggle="tooltip" data-target="#viewModal<?php echo $data_all_teknisi->nik; ?>" title="View">
                                                            <button type="button" class="btn btn-icon btn btn-success btn-sm" style="margin:0px;" data-bs-placement="bottom">
                                                                <i data-feather="eye"></i>
                                                            </button>
                                                        </a>
                                                        <a href="#" data-toggle="modal" data-bs-toggle="tooltip" data-target="#editModal<?php echo $data_all_teknisi->nik; ?>" title="Edit">
                                                            <button type="button" class="btn btn-icon btn-primary btn-sm" data-editid="{{$data_all_teknisi->nik}}" style="margin:0px;" data-bs-placement="bottom">
                                                                <i data-feather="edit"></i>
                                                            </button>
                                                        </a>
                                                        <a href="/delete/teknisi/{{ $data_all_teknisi->nik }}" data-toggle="modal" data-target="#deleteModal<?php echo $data_all_teknisi->nik; ?>" data-bs-toggle="tooltip" title="Delete">
                                            ...
                                            <!-- Delete Warning Modal -->
                                                <div class="modal fade" id="deleteModal<?php echo $data_all_teknisi->nik; ?>" tabindex="-1" role="dialog" aria-labelledby="Delete" aria-hidden="true">
                                            ...
                                            <!-- View screen modal -->
                                                <div class="modal fade" id="viewModal<?php echo $data_all_teknisi->nik; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                                            ...
                                                                            <div class="user-avatar-section">
                                                                                <div class="d-flex align-items-center flex-column">
                                                                                    ...
                                                                                    <div class="user-info text-center">
                                                                                        ...
                                                                                        <span class="badge bg-light-secondary">CCAN Technician</span>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                            ...
                                            <!-- Edit screen modal -->
                                                <div class="modal fade" id="editModal<?php echo $data_all_teknisi->nik; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                    <div class="modal-dialog modal-lg" role="document">
                                                        <div class="modal-content">
                                                            
                                                        <div class="modal-header bg-outline-primary">
                                                            <h4 class="modal-title"><b>Edit Data Teknisi</b></h4>
                                                            <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close"></button>
                                                        </div>

                                                        <div class="modal-body pb-5 px-sm-5 pt-50">
                                                            <div class="text-center mb-2 mt-2">
                                                                <h1 class="mb-1">Ubah Informasi Data Diri Teknisi</h1>
                                                                <p class="mb-3">Pastikan Data Teknisi Sudah Benar.</p>
                                                            </div>
                                                                <form id="edit_form<?php echo $data_all_teknisi->id; ?>" class="form" action="/update_teknisi" method="post">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-md-6 col-12">
                                                                            <div class="mb-1" >
                                                                                ...
                                                                                <input type="number" id="nik" class="form-control bg-white" value="{{ $data_all_teknisi->nik}}" aria-label="readonly input example" name="nik" required/>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6 col-12">
                                                                            <div class="mb-1 position-relative">
                                                                                <label class="form-label" for="teknisi_name">Nama Teknisi</label>
                                                                                <input type="text" class="form-control bg-white" name="teknisi_name" id="teknisi_name" value="{{ $data_all_teknisi->teknisi_name }}" aria-label="readonly input example" name="teknisi_name" required/>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6 col-12">
                                                                            <div class="mb-1 position-relative">
                                                                                <label class="form-label" for="no_hp">No. Telp</label>
                                                                                <input type="number" class="form-control bg-white" name="no_hp" id="no_hp" value="{{ $data_all_teknisi->no_hp }}" aria-label="readonly input example" name="no_hp" required/>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6 col-12">
                                                                            <div class="mb-1 position-relative">
                                                                                <label class="form-label" for="tgl_lahir">Tgl Lahir</label>
                                                                                <input type="text" class="form-control flatpickr-basic" name="tgl_lahir" id="tgl_lahir" placeholder="1990-11-27" value="{{ $data_all_teknisi->tgl_lahir }}"/>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6 col-12">
                                                                            <div class="mb-1 position-relative">
                                                                                <label class="form-label" for="email">Email</label>
                                                                                <input type="text" class="form-control bg-white" name="email" id="email" value="{{ $data_all_teknisi->email }}" aria-label="readonly input example" name="email" required/>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-md-6 col-12">
                                                                            <div class="mb-1 position-relative">
                                                                                <label class="form-label" for="no_ktp">No. KTP</label>
                                                                                <input type="number" class="form-control bg-white" name="no_ktp" id="no_ktp" value="{{ $data_all_teknisi->no_ktp }}" aria-label="readonly input example" name="no_ktp" required/>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-12">
                                                                            <br>
