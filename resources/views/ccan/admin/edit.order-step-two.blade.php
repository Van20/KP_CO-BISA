            ...
            <div class="content-body">
                ...
                <section class="vertical-wizard">
                    <div class="bs-stepper horizontal-wizard-example">
                        ...
                        <form class="bs-stepper-content" action="/edit_order/edit-step-one-post" method="post">
                        {{ csrf_field() }}
                        <input type="hidden" name="id" value="{{ $order_datin_edit->id }}"> 
                            <div class="bs-stepper-content">
                            <div id="account-details-vertical" class="content" role="tabpanel" aria-labelledby="account-details-vertical-trigger"></div>
