    ...
    <div class="navbar-header">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class=" nav-item"><a class="d-flex align-items-center" href="{!! url('/dashboard'); !!}"><i data-feather="home"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Dashboard</span><span class="badge badge-light-warning rounded-pill ms-auto me-1"></span></a>
                </li>
                ...
                <li class=" nav-item"><a class="d-flex align-items-center" href="#"><i data-feather="user"></i><span class="menu-title text-truncate" data-i18n="User">Technician</span></a>
                    <ul class="menu-content">
                        ...
                        <li><a class="d-flex align-items-center" href="{!! url('/detail_teknisi'); !!}"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="View">Data</span></a>
                        </li>
                    </ul>
                </li>
            </ul>
            ...
            <div class="content-body">
                ...
                <section class="vertical-wizard">
                    <div class="bs-stepper horizontal-wizard-example">
                        ...
                        @foreach($datin_ccan_tbl as $order_datin_edit)
                        <form class="bs-stepper-content" action="{{ route('edit.order.step.one.post') }}" method="post">
                        {{ csrf_field() }}
                        <input type="hidden" name="id" value="{{ $order_datin_edit->id }}"> 
                            <div class="bs-stepper-content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-1 col-md-6">
                                            <div class="mb-0">
                                                    ...
                                                    <select class="hide-search form-select" id="segment" name="segment" value="{{ $order_datin_edit->segment }}" required>
                                    ...
                                    <div class="row">
                                        <div class="mb-1 col-md-6">
                                            <div class="mb-1    ">
                                                    ...
                                                    <select class="hide-search form-select" id="status_order" name="status_order" value="{{ $order_datin_edit->status_order }}" required>
                                ...
                                <div id="personal-info-vertical" class="content" role="tabpanel" aria-labelledby="personal-info-vertical-trigger"></div>
                                <div id="address-step-vertical" class="content" role="tabpanel" aria-labelledby="address-step-vertical-trigger"></div>
                                <div id="social-links-vertical" class="content" role="tabpanel" aria-labelledby="social-links-vertical-trigger"></div>
                            </div>
                        </form>
                        @endforeach
                    </div>
