                        ...
                        <div class="col-md-6 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Reject Order</h4>
                                </div>
                                <div class="card-body">
                                    <form class="needs-validation" novalidate>
                                        <div class="mb-1">
                                            <label class="d-block form-label" for="validationBioBootstrap">Alasan Reject</label>
                                        ...
                                        <div class="mb-1">
                                            <label class="form-label" for="bsDob">Tanggal Reject</label>
