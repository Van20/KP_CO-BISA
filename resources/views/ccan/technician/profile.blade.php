                            ...
                            <div class="card">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li class="mb-75">
                                        ...
                                        <span>20 Desember 1999</span>
                                    </li>
                                    <li class="mb-75">
                                        <span class="fw-bolder me-25">Email : </span>
                                        <span>mn.mubarok@gmail.com</span>
                                    </li>
                                    <li class="mb-75">
                                        <span class="fw-bolder me-25">Contact : </span>
                                        <span>081334560871</span>
                                    </li>
                                    <li class="mb-75">
                                        <span class="fw-bolder me-25">No. KTP : </span>
                                        <span>350718009201</span>
                                    </li>
                                </ul>
                                </div>
                                <div>
                                    <a href="/form_profile"><button type="button" class="btn btn-secondary">Edit</button></a>
                                </div>
                            </div>
                        </div>
                            <!-- /User Card -->
